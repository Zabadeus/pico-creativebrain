...
from models.data_models import (
    VersionType, CleaningLevel, TimestampedSegment, ContentVersion
)
from utils.helpers import seconds_to_srt_time, seconds_to_vtt_time
...
class ContentVersionManager:
    ...
    def _export_vtt(self, version: ContentVersion) -> str:
        ...
        vtt_content = ["WEBVTT", ""]
        for segment in version.segments:
            start_time = seconds_to_vtt_time(segment.start_time)
            end_time = seconds_to_vtt_time(segment.end_time)
